...
Now that tat the new AChoir fork (MSVC + WinHTTP) has been stabilized and tested, 
this original Version will be left intact for those that prefer MingW.  However, all future 
development will be done to the AChoir fork. We recommend that you use the new AChoir fork
